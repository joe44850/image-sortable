...
class Image {
    ...
    drag(e){            
        if(this.move){
            ...
            let divUnder = this.getHoverDiv(e.clientX, e.clientY);
            if(this.previousHoverDiv && divUnder.id != this.previousHoverDiv){
                this.previousHoverDiv.className = "sortable-image image-stationary"
                divUnder.className ="sortable-image image-to-move";
                this.previousHoverDiv = divUnder;
            }
            else{
                this.previousHoverDiv = divUnder;
            }
    ...
    reposition(e){ 
        ...
        if(element && element.offsetLeft < this.sourceElement.offsetLeft){                   
            element.parentNode.insertBefore(this.sourceElement, element);
        } 
        else if(element){
    ...
    static Create(img, index){        
        ...
        el.id = "image_"+index;
        el.className = "sortable-image image-stationary";
